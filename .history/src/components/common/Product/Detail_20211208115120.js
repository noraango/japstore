...
export default function Detail(props) {
  ...
  function incrementValue(e) {
    if (number < product.quantity) setNumber(number + 1);
  }
    ...
    <div className={`container ${styles.container}`}>
          ...
          <div className={"product-infor"}>
            <div style={{borderBlockEnd:"1px solid black"}}>
              <div className="total-rate">
                Đánh Giá :{" "}
                <span className={" red"}>{product.rating}/5</span>
              </div>
              <p className={"brand"}>
            ...
            <div style={{paddingTop:"15px", borderBlockEnd:"1px solid black"}}>
            ...
            <div className="row" style={{paddingTop:"15px", borderBlockEnd:"1px solid black"}}>
              <h5 className="pb-3">
      ...
      <div className="product-rate">
        ...
        {RatingList.data? (
          ...
          <div className={styles.container}>Không có đánh giá nào để hiển thị</div>
        )}
      </div>
    </div>
  );
