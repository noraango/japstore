  ...
  return (
    <div>
      ...
      >
        ...
        <Modal.Footer>
        <button style={{padding:"8px 15px"}} onClick={forgot}>Đóng</button>
          <button style={{padding:"8px 15px"}} onClick={forgot}>Lấy mật khẩu</button>
        </Modal.Footer>
      </Modal>
      <div className={`${styles.container}`}>
        ...
        <div className={`${styles.divCheckBox}`}>
          <p onClick={(e)=>{setShow(true)}} style={{cursor:"pointer",marginRight:"10px"}}>Quên mật khẩu</p>
